    ...
    <el-card>
      <el-form style="display: flex; justify-content: space-between; height: 2vw">
        <el-form-item label="套餐名">
          <el-input placeholder="请输入套餐名进行搜索"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button slot="append" style="margin-left: 5px">搜索套餐</el-button>
          <el-button slot="append" style="margin-left: 5px" @click="addContent">添加套餐</el-button>
          <el-button slot="append" style="margin-left: 5px">重置套餐</el-button>
          <el-button slot="append" style="margin-left: 5px">删除套餐</el-button>
        </el-form-item>
      </el-form>
    </el-card>
