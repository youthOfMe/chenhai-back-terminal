  ...
  <div>
    ...
    <el-card style="margin-top: 5px">
      ...
      >
        ...
        <el-table-column prop="role" width="110" label="状态"></el-table-column>
        <el-table-column
          prop="name"
          width="110"
          label="排序值"
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column prop="date" width="110" label="展示开始时间"></el-table-column>
        <el-table-column prop="date" width="110" label="展示结束时间"></el-table-column>
        <el-table-column prop="name" width="200" label="图片" show-overflow-tooltip>
          <img
