  ...
  <div>
    ...
    <el-card style="margin-top: 5px">
      ...
      >
        ...
        <el-table-column prop="name" label="资料名称" width="100"></el-table-column>
        <el-table-column prop="name" label="资料描述" width="100"></el-table-column>
        <el-table-column prop="name" label="资料上传人" width="100"></el-table-column>
        <el-table-column prop="name" width="150" label="资料封面" show-overflow-tooltip>
          <img
        ...
        <el-table-column prop="role" label="资料链接" width="100"></el-table-column>
