    ...
    <el-card style="margin-top: 5px">
      ...
      >
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        ></el-table-column>
        <el-table-column prop="name" min-width="50%" label="专栏封面" show-overflow-tooltip>
          <img
        ...
        <el-table-column style="display: flex; flex-direction: row" label="操作">
          <template #default="{ row }">
            <div class="dialog-footer" style="width: 15vw">
