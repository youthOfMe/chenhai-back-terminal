...
const de = o(
  ...
  we = { style: { width: '60vw' } },
  Ve = ['src'],
  be = { class: 'el-upload-list__item-actions' },
  ye = ['onClick'],
  he = ['onClick'],
  Ce = ['onClick'],
  ke = ['src'],
  ...
  De = ee({
    ...
    setup(ze) {
      ...
      const P = d(0),
        R = d()
      R.value = []
      const b = d({ page: 1, pageSize: 10, keyword: '' }),
        U = d(!1),
        u = d({ name: '', description: '', size: '', price: '' }),
        p = d({ name: '', description: '', size: '', price: '' })
      te(() => {
        $()
      })
      async function $() {
                ...
                default: l(() => [
                  oe(
                    ...
                    ne(
                      ...
                      {
                        default: l(() => [
                          e(s, { type: 'selection', fixed: '' }),
                          e(s, { type: 'index', label: '序号', width: '70', fixed: '' }),
                          e(s, { prop: 'id', label: 'ID', width: '100' }),
                          e(s, { prop: 'name', label: '资料名称', width: '100' }),
                          e(s, { prop: 'name', label: '资料描述', width: '100' }),
                          e(s, { prop: 'name', label: '资料上传人', width: '100' }),
                          e(
                            s,
                            {
                              prop: 'name',
                          ...
                          e(s, { prop: 'name', label: '类型', width: '100' }),
                          e(s, { prop: 'role', label: '资料链接', width: '100' }),
                          e(s, { prop: 'date', label: '添加时间', width: '150' }),
                          e(s, { prop: 'date', label: '更新时间', width: '150' }),
                          e(
                            s,
                            ...
                            { span: 12, style: { width: '100%' } },
                            {
                              default: l(() => [
                                ...
                                e(
                                  ...
                                  {
                                    modelValue: C.value,
                                    'onUpdate:modelValue': a[12] || (a[12] = (t) => (C.value = t)),
                                  },
                                  {
                                    default: l(() => [
                                      o(
